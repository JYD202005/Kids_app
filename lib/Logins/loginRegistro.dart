  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Registro del mocoso',
            style: TextStyle(
              color: Colors.white,
              fontSize: 24.0,
            )),
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: Colors.white.withOpacity(0.5),
                        labelText: 'Contraseña de recuperación',
                        labelStyle: TextStyle(
                          color: Colors.black,
                          fontSize: 28,
                          fontWeight: FontWeight.w700,
                          ...
                          onPressed: () async {
                            if (_isLoading == false &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                      'Por favor, espera a que se complete la verificación o ${_segundosRestantes} segundos para solicitar un nuevo codigo.'),
                                  duration: Duration(seconds: 2),
                                ),
                              );
                            }
                          },
                          label: const Text('Registrar al mocoso',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16.0,
                              )),
                    ...
                    if (_isLoading || _esperandoVerificacion)
                      Padding(
                            ...
                            SizedBox(
                              ...
                              child: TextButton.icon(
                                onPressed: () async {
                                  ...
                                  final verificacionExitosa =
                                      await verificacion();
                                  setState(() {
                                    _isLoading = false;
                                    _esperandoVerificacion =
                                        !verificacionExitosa;
                                  });
                                  ...
                                  if (verificacionExitosa) {
                                    await completarRegistro(
                                      email: _email.text.trim(),
                                      password:
                                          passwordRecuperacion.text.trim(),
                                      nombreNino: nombreDelUsuario.text.trim(),
                                      nombrePadre: nombreDelPadre.text.trim(),
                                    );
                                  } else {
